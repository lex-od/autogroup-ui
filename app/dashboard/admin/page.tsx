...
import { AlertTriangle, Info, Users, Key, MessageSquare, Plus } from 'lucide-react';
        ...
        <Card className="bg-blue-50 border-blue-200">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                <div className="font-medium text-blue-900">✅ Доступные функции:</div>
              ...
              <div className="space-y-2">
                <div className="font-medium text-blue-900">🔧 Быстрые действия:</div>
                <div className="space-y-2">
                  <Button size="sm" onClick={handleCreateUser} className="w-full gap-2">
                    <Users className="h-4 w-4" />
                    Добавить пользователя
                  </Button>
                  <Button size="sm" variant="outline" onClick={handleCreateApiConfig} className="w-full gap-2">
                    <Key className="h-4 w-4" />
                    Добавить API-ключ
                  </Button>
                  <Button size="sm" variant="outline" onClick={handleCreatePrompt} className="w-full gap-2">
              ...
              <div className="space-y-2">
                <div className="font-medium text-blue-900">📊 Статус системы:</div>
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    <Badge className="bg-green-100 text-green-800">✅ Система работает</Badge>
                  </div>
                  <div className="flex items-center gap-2">
                    <Badge className="bg-green-100 text-green-800">✅ API доступны</Badge>
                  </div>
                  <div className="flex items-center gap-2">
        ...
        {showCreateUserModal && (
          <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
            <Card className="w-full max-w-md">
              ...
              <CardContent>
                <Button onClick={() => setShowCreateUserModal(false)}>Закрыть</Button>
              </CardContent>
            </Card>
          </div>
        )}
        ...
        {showCreateApiModal && (
          <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
            <Card className="w-full max-w-md">
              ...
              <CardContent>
                <Button onClick={() => setShowCreateApiModal(false)}>Закрыть</Button>
              </CardContent>
            </Card>
          </div>
        )}
        ...
        {showCreatePromptModal && (
          <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
            <Card className="w-full max-w-md">
              ...
              <CardContent>
                <Button onClick={() => setShowCreatePromptModal(false)}>Закрыть</Button>
              </CardContent>
            </Card>
          </div>
        )}
