...
const CallsJournalScreen = () => {
  ...
  const handleExport = async (format: 'csv' | 'xlsx') => {
    try {
      await exportCallsMutation.mutateAsync({
        format,
    ...
    <div className="w-full h-full">
      <div className="p-4 lg:p-6 space-y-6 max-w-full mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold tracking-tight">Журнал звонков</h1>
            <p className="text-muted-foreground">
              Управление и анализ всех телефонных звонков
            </p>
          </div>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-sm font-medium">Всего звонков</p>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-sm font-medium">Завершенные</p>
                  <p className="text-2xl font-bold">
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-sm font-medium">Пропущенные</p>
                  <p className="text-2xl font-bold">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                <span>Показано {calls.length} из {totalCalls}</span>
              </div>
            </div>
          </CardHeader>
          <CardContent>
